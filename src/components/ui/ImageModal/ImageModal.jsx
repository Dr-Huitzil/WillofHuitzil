// src/components/ui/ImageModal/ImageModal.jsx
...
const ImageModal = ({ imageUrl, title, onClose }) => {
  // Use the shared iOS-safe scroll lock (consistent with all other modals)
  useBodyScrollLock();
  ...
  return createPortal(
    <div className={styles.modalBackdrop} onClick={onClose}>
      <div className={styles.modalContent} onClick={e => e.stopPropagation()}>
        <button className={styles.closeBtn} onClick={onClose} aria-label="Close image modal">
