        ...
        <div className="modal-right">
          <div className="modal-tags">
            {project.tags?.map(tag => (
              <span key={tag} className="mono-accent tag">[{tag.toUpperCase()}]</span>
            ))}
          </div>
          <h2 className="serif-header modal-title">{project.title}</h2>
          
          <div className="project-description">
            <p>{project.description}</p>
          </div>

          <div className="modal-links mono-accent">
          ...
          <div className="modal-footer-text mono-accent">
